...
public class AuthController {
	...
	// @ApiOperation(value = "AWS health check", response = ResponseEntity.class)
		...
		/*
		 * @GetMapping(path = "/health") public ResponseEntity<Object> healthCheckup() {
		 * //Health check for AWS LOGGER.info("AWS Health Check "); return new return
		 * new ResponseEntity<>("status is ok", HttpStatus.OK); }
		 */
